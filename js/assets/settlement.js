const settlementTables = {
  ...
  populationValues: ["fewer than 51", "51-200", "201-1 000", "1 001 - 5 000", "5 001 - 25 000", "25 001 - 50 000", "50 001 - 250 000", "More than 250 000"],

  sizeLabels: ["Thorp", "Hamlet", "Village", "Small Town", "Large Town", "Small City", "Large City", "Metropolis"],

  baseValues: [50, 200, 500, 1000, 2000, 4000, 8000, 16000],

  purchaseLimits: [500, 1000, 2500, 5000, 10000, 25000, 50000, 100000],

  spellcastingIndexes: ["0th", "1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th", "9th"],

  magicItemsBySpellcasting: ["-", "-", "-", "-", "1d4", "1d6", "2d4", "3d4", "3d4", "4d4", "4d4", "*"],
  // offset minor magic items by +4, and medium magic items by +2

  qualitiesValues: [1, 1, 2, 2, 3, 4, 5, 6],
  modifiers: [-4, -2, -1, 0, 0, 1, 2, 4],
  dangers: [-10, -5, 0, 0, 5, 5, 10, 10],
